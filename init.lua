...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        angularls = {
          capabilities = { referencesProvider = vim.bo.filetype == 'html' },
        },
        lua_ls = {
          -- cmd = { ... },
          -- filetypes = { ... },
      ...
      statusline.setup {
        ...
        content = {
          active = function()
            ...
            local fileinfo = string.format('%s[%s]', encoding, format)
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = function(_, opts)
      ...
      opts.ensure_installed =
        { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'json', 'angular', 'scss' }
